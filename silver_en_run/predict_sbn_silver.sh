...
REF_FILE=${INPUT_DATA}/${DATASET}.en.tok
#REF_FILE=${INPUT_DATA}/trans.en.tok
TARG_FILE=${INPUT_DATA}/${DATASET}.sbn.seq.en.model
...
python /home/p289796/ZH-SBN/data/4.postprocess_sbn_quota.py   ${OUT_DIR}/{$f}.pred.txt  ${OUT_DIR}/en.sbn.output.$DATASET
cp ${OUT_DIR}/en.sbn.output.$DATASET /home/p289796/SBN-evaluation/1.evaluation-tool-overall/model_output/
