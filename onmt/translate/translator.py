...
class Translator(object):
    ...
    def translate(self,
        ...
        if self.data_type == 'SBN':
            data_iter = inputters.SBNIterator(
        ...
        for batch in data_iter:
            ...
            for trans in translations:
                ...
                if attn_debug:
                    ...
                    if self.data_type == 'text' or self.data_type == 'SBN':
                        srcs = trans.src_raw
                    else:
    ...
    def _fast_translate_batch(self,
        ...
        assert data.data_type == 'text' or data.data_type == 'SBN'
        ...
        topk_log_probs = ([0.0] + [float("-inf")] * (beam_size - 1)).clone().detach()
    ...
    def _translate_batch(self, batch, data):
        ...
        src_map = rvar(batch.src_map.data) \
            if data_type in ['text','SBN'] and self.copy_attn else None
